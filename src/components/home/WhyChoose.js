            ...
            <div className="container">
                ...
                <div className="row fetured_row align-items-center">
                    ...
                    <div className="col-lg  col-md-12 text-center">
                        <img src={images['1.png']} alt="Diversity" className="object-cover w-half h-full rounded-xl"/>
                    </div>
                </div>
                <div className="row  fetured_row align-items-center">
                    <div className="col-lg  order-md-2 col-md-12 align-middle">
                        <h4 className="primary_color text-xl font-semibold leading-7">
                        Equity
                        </h4>
                        <p className="text-gray-600 text-base font-light leading-normal">
                    ...
                    <div className="col-lg   col-md-12 order-md-1 text-center">
                        <img src={images['2.png']} alt="Equity" className="object-cover w-half h-full rounded-xl"/>
                    </div>
                </div>
                <div className="row  fetured_row align-items-center">
                    ...
                    <div className="col-lg  col-md-12  col-sm-12 text-center">
                        <img src={images['3.png']} alt="Diversity" className="object-cover w-half h-full rounded-xl"/>
                    </div>
                </div>
            </div>
        </section>
